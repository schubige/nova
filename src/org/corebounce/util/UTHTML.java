...
public class UTHTML extends UnicodeTranslator implements Unicode {
	...
	final static String[] UNICODE2HTML = { 
		...
		Igrave, "&Igrave;", Iacute, "&Iacute;", Icirci, "&Icirci;", Iuml, "&Iuml;",
		...
		Ugrave, "&Ugrave;", Uacute, "&Uacute;", Ucircr, "&Ucircr;", Uuml, "&Uuml;",

		Yacute, "&Yacute;", THORN, "&THORN;", // latin capital letter thorn
		...
		ugrave, "&ugrave;", ucute, "&ucute;", ucircr, "&ucircr;", uuml, "&uuml;",

		yacute, "&yacute;", thorn, "&thorn;", // latin small letter thorn
		yuml, "&yuml;",
	...
	public String getUnicode(String nstr) {
		return UnicodeTrans._trans(nstr, HTML2UNICODE);
	}
