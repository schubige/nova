 ...
 * 
 * Use <code>java iiuf.util.UnicodeTranslator</code> to dump a printable form of
 * this table.
 * 
...
public interface Unicode {
	...
	public final static String Lt = "\u00AB"; // left pointing double angle
												// quotation mark
	...
	public final static String inodot = "\u0131"; // LATIN SMALL LETTER DOTLESS
													// I
	...
	public final static String Yuml = "\u0178"; // LATIN CAPITAL LETTER Y WITH
												// DIAERESIS
	public final static String fnof = "\u0192"; // LATIN SMALL LETTER F WITH
												// HOOK
	...
	public final static String lsaquo = "\u2039"; // SINGLE LEFT-POINTING ANGLE
													// QUOTATION MARK
	public final static String rsaquo = "\u203A"; // SINGLE RIGHT-POINTING ANGLE
													// QUOTATION MARK
